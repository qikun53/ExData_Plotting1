...
#1page
plot(x,parsed_data$Global_active_power, typ='l', ylab="Global Active Power", xlab="")
#axis(1, at=c(0,1440,2880),labels=c('Thu','Fri','Sat'))

#2page
plot(x,parsed_data$Voltage, typ='l', ylab="Voltage", xlab="",sub="datetime")
#axis(1, at=c(0,1440,2880),labels=c('Thu','Fri','Sat'))
...
#4page
plot(x,parsed_data$Global_reactive_power, typ='l', ylab="Global_rective_power", xlab="",main='',sub='datetime')
#axis(1, at=c(0,1440,2880),labels=c('Thu','Fri','Sat'))
